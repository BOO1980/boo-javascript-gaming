...
class PlayScene extends Phaser.Scene{
    ...
    createPauseButton(){
        const pauseButton = this.add
            .image(this.config.pauseButtonPosition.x, this.config.pauseButtonPosition.y, "pauseButton")
            .setInteractive()
            .setScale(3)
            .setOrigin(1,1);
    ...
    createColliders(){
        this.physics.add.collider(this.bird, this.pipes, this.gameOver, null, this); // specifiy what objects you want to collide
    }
    ...
    gameOver() {
        ...
        this.time.addEvent({
            ...
            loop:false //we dont want this to loop every 1 second
        });
    }
